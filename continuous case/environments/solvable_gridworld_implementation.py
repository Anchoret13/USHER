...
break_chance = 0#1.0#.2#.6
# BREAKING = False
BREAKING = True
obstacle_density = 0.1
GRID_DISPLAY = False#True
DT = 0.5
observation_bias = 0#1.0
base_size = 8
...
class AltGridworldEnv(GoalEnv):
	...
	def get_obs(self):
		...
		return {
			...
			# "observation": np.append(np.append(state_obs, surroundings), self.one_hot),
			# "observation": np.append(state_obs, self.one_hot),
